...
# goreporter [![Version Status](https://img.shields.io/badge/v3.0-release-blue.svg)](https://github.com/bnulwh/goreporter/releases/tag/version3.0)

[![Current Release](https://img.shields.io/github/release/bnulwh/goreporter.svg)](https://github.com/bnulwh/goreporter/releases/latest)
[![Build Status](https://travis-ci.org/bnulwh/goreporter.svg?branch=master)](https://travis-ci.org/bnulwh/goreporter)
[![GoDoc](https://godoc.org/github.com/bnulwh/goreporter?status.svg)](https://godoc.org/github.com/bnulwh/goreporter)
...
- [unittest](https://github.com/bnulwh/goreporter/tree/master/linters/unittest) - Golang unit test status.
...
- [depth](https://github.com/bnulwh/goreporter/tree/feature-3.0/linters/depth) - Count the maxdepth of go functions.
...
```bash
go get -u github.com/bnulwh/goreporter
```
